...
## Project Structure
    ...
    ├── testapiautodatamod_121290  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_121290`
...
2. Clone this repo and `cd testapiautodatamod_121290`
